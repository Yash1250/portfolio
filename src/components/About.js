    ...
    <div
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col justify-center p-4 w-full h-full">
        ...
        <p className="text-xl">
          ...
          fresh perspectives and a willingness to learn and adapt quickly. My
          proficiency in these technologies enables me to hit the ground running
          and contribute effectively to your team's projects. I am eager to
          leverage my skills and grow alongside your organization, adding value
          and driving success.
        </p>
        <br />
        <p className="text-xl">
